...
public interface BeerRepository extends JpaRepository<Beer, UUID> {
    ...
    List<Beer> findAllByBeerNameIsLikeIgnoreCaseAndUpcIsLikeIgnoreCaseAndBeerStyleAndPriceGreaterThanAndPriceLessThanAndBeerNameContainsIgnoreCase(String beerName, String upc, BeerStyle beerStyle, BigDecimal price, BigDecimal price2, String beerName2);
}
